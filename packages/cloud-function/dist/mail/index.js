...
exports.createEmployeeAuth = exports.sendMail = void 0;
...
exports.sendMail = functions
    ...
    try {
        ...
        return new firebase_functions_1.https.HttpsError('aborted', err.toString());
    }
});
/**
 * メール送信
 ...
 * @returns 'success'
 */
exports.createEmployeeAuth = functions
    .region('asia-northeast1')
